...
class H(BaseHTTPRequestHandler):
    ...
    def _get(self):
        ...
        if path=="/":return send_html(self,render_page("home.html","AtlasBahamas",u,path))
        if path=="/about":return send_html(self,render_page("about.html","About AtlasBahamas",u,path))
        if path=="/contact":return send_html(self,render_page("contact.html","Contact AtlasBahamas",u,path))
        if path=="/changelog":
            if not u:
    ...
    def _admin_audit_export(self, u):
        ...
        return send_csv(self, "atlasbahamas_audit_log.csv", rows)
    ...
    def _landlord_export_properties(self, u):
        ...
        return send_csv(self, "atlasbahamas_properties.csv", rows)
    ...
    def _landlord_export_property_units(self, u, q):
        ...
        return send_csv(self, f"atlasbahamas_units_{safe}.csv", rows)
    ...
    def _landlord_export_listing_requests(self, u, filtered=False):
        ...
        fname = "atlasbahamas_listing_requests_filtered.csv" if filtered else "atlasbahamas_listing_requests.csv"
    ...
    def _landlord_export_checks(self, u):
        ...
        return send_csv(self, "atlasbahamas_property_checks.csv", rows)
