"""Experimental Flask scaffold for AtlasBahamas.
...
def create_app() -> Flask:
    ...
    def health() -> tuple[dict, int]:
        return {
            ...
            "mode": "flask-scaffold",
            "active_runtime": "server.py -> atlasbahamas_app.http_handler",
        }, 200
    ...
    def home_placeholder():
        return jsonify(
            {
                "ok": False,
                "message": "Flask scaffold only. Use server.py or wsgi.py for real AtlasBahamas runtime.",
            }
        ), 503
